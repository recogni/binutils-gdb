...
#define YYSTYPE         ADA_STYPE
/* Substitute the variable and function names.  */
#define yyparse         ada_parse
...
#endif  /* ! defined ADA_DEBUG */
#if ADA_DEBUG
extern int ada_debug;
#endif

/* Token type.  */
#ifndef ADA_TOKENTYPE
# define ADA_TOKENTYPE
  enum ada_tokentype
  {
    INT = 258,
    NULL_PTR = 259,
...
# define ADA_STYPE_IS_TRIVIAL 1
# define ADA_STYPE_IS_DECLARED 1
#endif


extern ADA_STYPE ada_lval;
...
# endif
     ...
     && (! defined __cplusplus \
         || (defined ADA_STYPE_IS_TRIVIAL && ADA_STYPE_IS_TRIVIAL)))
...
{
       0,   183,   183,   187,   188,   190,   195,   199,   204,   210,
     229,   229,   241,   245,   247,   255,   266,   276,   280,   283,
     286,   290,   294,   298,   302,   305,   307,   309,   311,   315,
     328,   332,   336,   340,   344,   348,   352,   356,   360,   364,
     367,   371,   375,   379,   381,   386,   394,   398,   404,   415,
     419,   423,   427,   428,   429,   430,   431,   432,   436,   438,
     443,   445,   450,   452,   457,   459,   463,   465,   477,   479,
     486,   489,   492,   495,   497,   499,   501,   503,   505,   507,
     511,   513,   518,   528,   530,   537,   541,   549,   557,   561,
     567,   569,   573,   577,   579,   581,   589,   600,   602,   607,
     616,   617,   623,   628,   634,   643,   644,   645,   649,   654,
     669,   668,   671,   674,   673,   680,   679,   682,   685,   684,
     692,   694,   696
};
#endif

#if ADA_DEBUG || YYERROR_VERBOSE || 0
